...
public class MyAspect {
     ...
     * 3.不会影响目标方法的执行。
     */
    /*@Before(value = "execution(public void com.ggs.ba01.SomeServiceImpl.doSome(String,Integer))")
    public void myBefore() {
        // 就是你切面要执行的功能代码
        System.out.println("前置通知， 切面功能：在目标方法之前输出执行时间：" + new Date());
    }*/

    /*@Before(value = "execution(void com.ggs.ba01.SomeServiceImpl.doSome(String,Integer))")
    public void myBefore() {
        // 就是你切面要执行的功能代码
    ...
    /*@Before(value = "execution(* com.ggs.ba01.*ServiceImpl.*(..))")
    public void myBefore2() {
        // 就是你切面要执行的功能代码
        System.out.println("2=====前置通知， 切面功能：在目标方法之前输出执行时间：" + new Date());
    }*/
